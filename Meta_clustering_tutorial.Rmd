...
for (i in 1:length(uniqueGroups)){
  ...
  #Age range stats
  Age17Stats = pCI(data_analysis_metadata_subgroup$Age == '<18', alphaci)*100
  ...
  Age65Stats = pCI(data_analysis_metadata_subgroup$Age == '>64', alphaci)*100
